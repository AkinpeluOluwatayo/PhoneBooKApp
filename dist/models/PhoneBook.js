...
class PhoneBook {
    ...
    addContact(name, phoneNumber) {
        ...
        this.contact.push(new Contact_1.Contact(name, phoneNumber)); // i am creating new instance passing d prameter nd pushing
    ...
    removeContact(name, phoneNumber) {
        this.contact = this.contact.filter(c => !(c.name === name && c.phoneNumber === phoneNumber)); // i am creating new object here of contact list a
